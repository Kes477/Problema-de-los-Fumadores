...
public class Main {
	 ...
	 * fumador con fósforo, agente y mesa; 
    ...
    public static void main(String[] args) {
    	...
    	Fumador fumadorConTabaco = new Fumador(util, mesa, semaforo, 1);
    	Fumador fumadorConPapel = new Fumador(util, mesa, semaforo, 2);
    	Fumador fumadorConFosforo = new Fumador(util, mesa, semaforo, 3);
